...
var validateJsonStructure = function(extensionDescriptor) {
  ...
  ajv.addSchema(extensionDescriptorSchema);

  if (extensionDescriptor.platform === 'mobile') {
    ajv.addSchema(require('@adobe/reactor-turbine-schemas/schemas/extension-package-mobile.json'));
  } else {
    ajv.addSchema(require('@adobe/reactor-turbine-schemas/schemas/extension-package-web.json'));
  }
